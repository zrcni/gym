(ns gym.backend.workouts.controllers.core
  (:require [gym.backend.workouts.controllers.get-workouts-by-user-id :as get-workouts-by-user-id-controller]
            [gym.backend.workouts.controllers.get-workout-by-workout-id :as get-workout-by-workout-id-controller]
            [gym.backend.workouts.controllers.create-workout :as create-workout-controller]
            [gym.backend.workouts.controllers.delete-workout-by-workout-id :as delete-workout-by-workout-id-controller]
            [gym.backend.workouts.controllers.get-current-week-exercises-total-duration :as get-current-week-exercises-total-duration-controller]
            [gym.backend.workouts.controllers.get-current-month-exercises-total-duration :as get-current-month-exercises-total-duration-controller]))
